...
<html>
  <head>
    ...
    <title>Quellaqef - Your request has been accepted!</title>
    <meta property="og:title" content="Quellaqef - Your request has been accepted!" />
    <meta property="og:image" content="logo.svg" />
    
    <meta property="og:description" content="Quellaqef - Your request has been accepted!" />
    <meta name="description" content="Quellaqef - Your request has been accepted!" />
...
<style>
	* {
	...
	.bodyClass1-brandab-banner{
		background: #fffef8;
		color: #ffffff;
	}
	.bodyClass2-brandab-banner{
		background: #fff5ea;
		color: #fff;
	}
	.bodyClass3-brandab-banner{
		background: #fff;
		color: #111;
	}
	.wrapage-block-brandab-banner{
		background-size: 100%;
		width: 100%;
	}
	.box_main-brandab-banner{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-brandab-banner h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-brandab-banner p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-brandab-banner{
		text-align: center;
	}
	.mainBlock-brandab-banner ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-brandab-banner ul>li span{
		font-weight: bold;
	}
	.mainBlock-brandab-banner{
		max-width: 850px;
	...
	.mainBlock-brandab-banner .cBlock-brandab-banner{
		text-align: center;
	}

	.bodyClass3-brandab-banner .mainBlock-brandab-banner{
		background: none;
		border-top: 2px dashed #fff5ea;
		border-bottom: 2px dashed #fff5ea;
	}
	.bodyClass2-brandab-banner .mainBlock-brandab-banner{
		background: #161616;
		color: #fff !important;
		box-shadow: 0px 0px 15px #161616;
	}
	.bodyClass2-brandab-banner .mainBlock-brandab-banner p{
		color: #fff !important;
	}
	.bodyClass1-brandab-banner .mainBlock-brandab-banner{
		background: #0A4F3C;
		color: #ffffff;
		border-left: 4px solid #2F3032;
	}
	.bodyClass1-brandab-banner .mainBlock-brandab-banner p{
		color: #ffffff !important;
	}
	.order-brandab-banner{
...
<div class="bodyClass1-brandab-banner" id="mainWrapp-brandab-banner">


	<div class="wrapage-block-brandab-banner">
		<div class="box_main-brandab-banner">
			<div class="mainBlock-brandab-banner">
...
<p class="cBlock-brandab-banner">Warmest regards, The Team!</p>
			</div>
		</div>
	</div>
